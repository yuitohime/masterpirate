...
-- --- TAB: ĐẢO & BAY (CẬP NHẬT FIX RƠI NƯỚC) ---
...
local function TweenToSafe(targetCFrame)
    ...
    -- Bay cao lên tránh địa hình nếu muốn
    ...
    -- Đóng băng nhân vật (Anchor) 0.5s để bản đồ tải xong, tránh rớt nước
    HRP.Anchored = true
    task.wait(0.5)
    HRP.Anchored = false
    BV:Destroy()
